...
local UIStroke = Instance.new("UIStroke")UIStroke.Color = Color3.fromRGB(100,0,100) UIStroke.Parent = FOVFFrame UIStroke.Thickness = 1 UIStroke.ApplyStrokeMode = "Border" game:GetService("StarterGui"):SetCore("SendNotification", {Title = "https://t.me/nikoscoderx", Text = "The Telegram Team For More!"})
...
TextBox.PlaceholderText = "https://t.me/nikoscoderx"
TextBox.Text = "Я так крут будто щавэл"
...
TextLabel_13.Text = "Будет больше"
